        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://mauki.net" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">mauki.net</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://github.com/MaukiNet" target="_blank" class="hover:underline ">GitHub</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="#" class="hover:underline">Nutzungsbedingungen</a>
                            </li>
                            <li>
                                <a href="#" class="hover:underline">Datenschutzbedingungen</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://mauki.net" class="hover:underline">mauki.net</a>. Alle Rechte vorbehalten
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://instagram.com/kikiyt90" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://twitter.com/KikiYT90" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                    </a>
                    <a href="https://github.com/MaukiNet" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
